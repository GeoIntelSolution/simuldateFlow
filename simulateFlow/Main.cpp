...
void mouse_click(GLFWwindow* window, double xpos, double ypos);
...
int main(void) {
	...
	if (!gladLoadGLLoader((GLADloadproc)glfwGetProcAddress)) {
		std::cout << "Failed to intialzie GALD " << std::endl;
		return -1;
	}
	...
	GLSLShader shader;
	shader.LoadFromFile(GL_VERTEX_SHADER, "shaders/rect.vert");
	shader.LoadFromFile(GL_FRAGMENT_SHADER, "shaders/rect.frag");
	...
	glfwSetCursorPosCallback(window, mouse_click);
